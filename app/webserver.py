...
@app.get("/version")
async def version():
    return {"version":"7.7.6","work_shifts":6,"work_reward_multiplier":1.5,"title_income_bonuses":True,"title_potions":True,"npc_progression":"1-50 with ascension at 20 and 30","npc_stats":True,"player_stories":True,"story_slideshow":True,"secret_story_achievement":True,"live_work_timer":True,"compact_npc_cards":True,"friends_visits":True,"shared_households":True,"summer_guard_until":"2026-08-25"}
